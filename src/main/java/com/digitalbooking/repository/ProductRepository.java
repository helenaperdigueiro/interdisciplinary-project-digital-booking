...
public interface ProductRepository extends JpaRepository<Product, Integer> {
    ...
    @Query("select p from Product p inner join p.reservations r where p.city.name = :name" +
            " and (:start  between r.startDate and r.endDate or :end  between r.startDate and r.endDate" +
            " or r.startDate between :start and :end)")
